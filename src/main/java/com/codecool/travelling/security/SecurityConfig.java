...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/position/add-position").hasRole("ADMIN") // allowed if signed in with COMPANY role
                .antMatchers("/salesman/**").permitAll() //allowed by anyone
                //.antMatchers("/personality/match-person-to-role/**").hasRole("USER") //allowed if signed in as SALESMAN
                //.antMatchers("/personality/get-all-matching-position/**").hasRole("USER") //allowed if signed in as SALESMAN
